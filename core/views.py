...
from .models import Grade, Student, ProgramOutcome
...
def instructor_dashboard(request):
    return render(request, 'instructor.html', {'section': 'dashboard'})

@faculty_head_required
def faculty_head_dashboard(request):
    return render(request, 'faculty_head.html')

def instructor_personal_info(request):
    return render(request, 'instructor.html', {'section': 'personal-info'})


def instructor_my_courses(request):
    return render(request, 'instructor.html', {'section': 'my-courses'})


def instructor_grades(request):
    return render(request, 'instructor.html', {'section': 'grades'})


def instructor_announcements(request):
    return render(request, 'instructor.html', {'section': 'announcements'})
...
def student_grades(request, username):
    ...
    for course_name in user_courses:
        grade_obj = next((g for g in grades_qs if g.course_name == course_name), None)
