...
urlpatterns = [
    ...
    path('student/announcements/recent/', core_views.student_recent_announcements, name='student_recent_announcements'),
    path('student/announcements/<str:announcement_id>/mark-read/', core_views.mark_announcement_as_read, name='mark_announcement_read'),
    ...
    path('instructor/learning-outcomes/get-existing/', core_views.get_existing_learning_outcomes, name='get_existing_learning_outcomes'),
    ...
    path('instructor/announcements/recent/', core_views.instructor_recent_announcements, name='instructor_recent_announcements'),
...
urlpatterns += [
    ...
    path('faculty-head/grades/<str:course_name>/update-multiple-grades/', core_views.update_multiple_grades, name='faculty-head-update-multiple-grades'),
    ...
    path('faculty-head/learning-outcomes/get-existing/', core_views.faculty_head_get_existing_learning_outcomes, name='faculty_head_get_existing_learning_outcomes'),
    ...
    path('faculty-head/announcements/recent/', core_views.faculty_head_recent_announcements, name='faculty_head_recent_announcements'),
    ...
    path('faculty-head/assignments/', core_views.faculty_head_assignments, name='faculty_head_assignments'),
    ...
    path('instructor/learning-outcomes/<int:outcome_id>/get-assessments/', core_views.get_available_assessments, name='get_available_assessments'),
    path('instructor/learning-outcomes/<int:outcome_id>/link-assessment/', core_views.link_assessment_to_lo, name='link_assessment_to_lo'),
    path('instructor/learning-outcomes/<int:outcome_id>/update-assessment-percentage/<int:relation_id>/', core_views.update_assessment_lo_percentage, name='update_assessment_lo_percentage'),
    path('instructor/learning-outcomes/<int:outcome_id>/unlink-assessment/<int:relation_id>/', core_views.unlink_assessment_from_lo, name='unlink_assessment_from_lo'),
    path('instructor/profile/', core_views.instructor_profile, name='instructor_profile'),
    path('instructor/announcements/', core_views.instructor_announcements, name='instructor_announcements'),
