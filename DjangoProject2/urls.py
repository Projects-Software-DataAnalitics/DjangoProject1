...
urlpatterns = [
    ...
    path('faculty-head/learning-outcomes/delete/<int:outcome_id>/', core_views.faculty_head_delete_learning_outcome, name='faculty_head_delete_learning_outcome'),
    path('faculty-head/learning-outcomes/detail/<int:outcome_id>/update-percentage/<int:program_outcome_id>/', core_views.faculty_head_update_percentage, name='faculty_head_update_percentage'),
    ...
    path('instructor/learning-outcomes/detail/<int:outcome_id>/update-percentage/<int:program_outcome_id>/', core_views.update_percentage, name='update_percentage'),
